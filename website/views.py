    ...
    if request.method == "POST":
        ...
        if user != None or user != {}:
            ...
            if bcrypt.checkpw(password, hashed_password):
                user = User(user['_id'], user['first_name'], user['last_name'], user['email'], True, False, True)
...
def preview():
    ...
    for row in user["certifications"]:
        temp_certifications = template["certication"]
    ...
    for row in user["volunteer"]:
        ...
        temp_volunteer = temp_volunteer.replace("description", row['description'])
    ...
    for row in user["extra"]:
        ...
        temp_extra = temp_extra.replace("name", row['name'])
    ...
    if certifications_history != "":
        certificationsTemplate = certificationsTemplate.replace('skills_history', skills_history)
    else:
